...
;Version13 uses an updated list of pulsars that does not include low S/N Pulsars

PRO iquvextract13finalplotmaker
...
header = ''
openr, lun, '/data/psrdata/VeniceHayden/IDLprograms/PulsarAscii/' + Jname[pulsarnumber] + '_20CM_coadded.SFTC.ascii', /get_lun
readf, lun, header
free_lun, lun
...
readcol, /silent, '/data/psrdata/VeniceHayden/IDLprograms/PulsarAscii/' + Jname[pulsarnumber] + '_20CM_coadded.SFTC.ascii',$
...
device, filename= Jname[pulsarnumber] + '.20CM.Final.Alpha&Beta.ps', xsize=28, ysize=20
